...
# -*- coding: utf-8 -*-
"""
Simple and accurate image inspection script
"""
import os
import argparse
...
def check_image_file_simple(image_path):
    """Simple check if image file is corrupted"""
    try:
...
def check_images_simple(image_dir, json_file=None):
    """Find and check corrupted image files (simple method)"""
...
def main():
    parser = argparse.ArgumentParser(description="Simple image inspection")
