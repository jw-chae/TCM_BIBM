...
# -*- coding: utf-8 -*-
"""
혀 이미지 데이터셋 증강 스크립트 (수정된 버전)
JSON 파일의 이미지 경로를 올바르게 처리합니다.
"""
...
class TongueImageAugmenter:
    def __init__(self, augmentation_factor=3):
        ...
        Args:
            augmentation_factor (int): 각 이미지당 생성할 증강된 이미지 수
        """
    ...
    def adjust_color_temperature(self, image, temp_range=(0.9, 1.1)):
        ...
        # 색온도 조정 (Color Balance)
        r, g, b = pil_image.split()
        
        if temp_factor > 1.0:  # 따뜻한 톤 (빨간색, 노란색 증가)
